...
根据这个定律，地球在近日点公转最快，在远日点最慢。这导致北半球春季（从春分到夏至）约为92.8天，夏季（从夏至到秋分）约93.6天，秋季（从秋分到冬至）约89.8天，冬季（从冬至到春分）约89.0天。
...
class AstronomicalCalculator:
    ...
    def calculate_sidereal_year(self):
        ...
        sidereal_year = tropical_year * precession_rate / (precession_rate - 1)
...
class EclipseCalculator:
    ...
    def calculate_near_eclipses(self, start_date, years=1):
        """
        计算指定时间段内的日月食
